...
game_name = '03_car_racing_duelingdqn'    # the name of the game being played for log files
...
class DQN_agent:
    ...
    def build_model(self, network_name):
        ...
        net1 = Convolution2D(32, 3, 3, subsample=(3, 3), border_mode='same',input_shape=(self.img_rows,self.img_cols,self.img_channels))(state)  #80*80*4
        net2 = Activation('relu')(net1)
        net3 = Convolution2D(64, 2, 2, subsample=(2, 2), border_mode='same')(net2)
        net4 = Activation('relu')(net3)
        net5 = Convolution2D(64, 2, 2, subsample=(1, 1), border_mode='same')(net4)
